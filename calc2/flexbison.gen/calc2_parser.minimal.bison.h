...
/**
 ** \file ./calc2/flexbison.gen/calc2_parser.minimal.bison.h
 ** Define the calc2min::parser class.
 */
...
#ifndef YY_YY_CALC2_PARSER_MINIMAL_BISON_H_INCLUDED
# define YY_YY_CALC2_PARSER_MINIMAL_BISON_H_INCLUDED
// "%code requires" blocks.
#line 38 "./calc2/grammar/calc2_parser.minimal.bison.y"
...
#line 79 "./calc2/flexbison.gen/calc2_parser.minimal.bison.h"
...
namespace calc2min {
#line 220 "./calc2/flexbison.gen/calc2_parser.minimal.bison.h"




  /// A Bison parser.
  class Calc2MinParser
  {
  public:
#ifdef YYSTYPE
# ifdef __GNUC__
...
switch (yykind)
    {
      ...
      {
        return Calc2MinParser::symbol_name (this->kind ());
      }
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   || (token::YYerror <= tok && tok <= token::TIMES));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    Calc2MinParser (function<Calc2MinParser::symbol_type(LexParam&)> yylex_yyarg, LexParam& lexParam_yyarg);
    virtual ~Calc2MinParser ();

#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    Calc2MinParser (const Calc2MinParser&) = delete;
    /// Non copyable.
    Calc2MinParser& operator= (const Calc2MinParser&) = delete;
#endif
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_INT (int64_t v, location_type l)
      {
      ...
      static
      symbol_type
      make_INT (const int64_t& v, const location_type& l)
      {
    ...
    {
    public:
      context (const Calc2MinParser& yyparser, const symbol_type& yyla);
    ...
    private:
      const Calc2MinParser& yyparser_;
...
#if YY_CPLUSPLUS < 201103L
    /// Non copyable.
    Calc2MinParser (const Calc2MinParser&);
    /// Non copyable.
    Calc2MinParser& operator= (const Calc2MinParser&);
#endif
  ...
  private:
    ...
    // User arguments.
    function<Calc2MinParser::symbol_type(LexParam&)> yylex;
    LexParam& lexParam;
  ...
  Calc2MinParser::yytranslate_ (int t) YY_NOEXCEPT
  {
  ...
  // basic_symbol.
  template <typename Base>
  Calc2MinParser::basic_symbol<Base>::basic_symbol (const basic_symbol& that)
    : Base (that)
    , value ()
  ...
  template <typename Base>
  Calc2MinParser::symbol_kind_type
  Calc2MinParser::basic_symbol<Base>::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
  ...
  template <typename Base>
  bool
  Calc2MinParser::basic_symbol<Base>::empty () const YY_NOEXCEPT
  {
  ...
  template <typename Base>
  void
  Calc2MinParser::basic_symbol<Base>::move (basic_symbol& s)
  {
    super_type::move (s);
    switch (this->kind ())
    {
  ...
  // by_kind.
  inline
  Calc2MinParser::by_kind::by_kind () YY_NOEXCEPT
    : kind_ (symbol_kind::S_YYEMPTY)
  {}

#if 201103L <= YY_CPLUSPLUS
  inline
  Calc2MinParser::by_kind::by_kind (by_kind&& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {
    that.clear ();
  }
  ...
  inline
  Calc2MinParser::by_kind::by_kind (const by_kind& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {}

  inline
  Calc2MinParser::by_kind::by_kind (token_kind_type t) YY_NOEXCEPT
  ...
  inline
  void
  Calc2MinParser::by_kind::clear () YY_NOEXCEPT
  {
    kind_ = symbol_kind::S_YYEMPTY;
  }
  ...
  inline
  void
  Calc2MinParser::by_kind::move (by_kind& that)
  {
    kind_ = that.kind_;
    that.clear ();
  }
  ...
  inline
  Calc2MinParser::symbol_kind_type
  Calc2MinParser::by_kind::kind () const YY_NOEXCEPT
  {
    return kind_;
  }
  ...
  inline
  Calc2MinParser::symbol_kind_type
  Calc2MinParser::by_kind::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
...
#line 1507 "./calc2/flexbison.gen/calc2_parser.minimal.bison.h"


// "%code provides" blocks.
#line 88 "./calc2/grammar/calc2_parser.minimal.bison.y"
...
#line 1523 "./calc2/flexbison.gen/calc2_parser.minimal.bison.h"


#endif // !YY_YY_CALC2_PARSER_MINIMAL_BISON_H_INCLUDED
