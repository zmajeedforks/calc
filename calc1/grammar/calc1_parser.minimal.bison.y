// calc1_parser.minimal.bison.y

// calc1 minimal parser without semantic actions to test grammar with real input
// bison --color=always -Wall -Wdangling-alias -Werror -Wcounterexamples --report counterexamples,lookaheads --report-file calc1_grammar_report.minimal.txt calc1_parser.minimal.bison.y
...
%define api.location.file "calc1_locations.minimal.bison.h"
...
%define api.namespace {calc1min}

// custom classname generated by bison
%define api.parser.class {Calc1MinParser}
...
%parse-param {function<Calc1MinParser::symbol_type(LexParam&)> yylex}
